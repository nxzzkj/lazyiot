namespace ScadaFlowDesign.Dialog
{
    ...
    public class SyBaseConnectionFrm : Form
    {
        private SyBase_Connection _connection;
        ...
        private void InitializeComponent()
        {
            ...
            // panel9
            // 
            this.panel9.Controls.Add(this.tbPort);
            ...
            // panel7
            // 
            this.panel7.Controls.Add(this.tbservername);
            ...
            // tbservername
            // 
            this.tbservername.Dock = System.Windows.Forms.DockStyle.Left;
            this.tbservername.Font = new System.Drawing.Font("微软雅黑", 10.5F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
            this.tbservername.Location = new System.Drawing.Point(77, 0);
            this.tbservername.Name = "tbservername";
            this.tbservername.Size = new System.Drawing.Size(295, 26);
            ...
            this.tbDataSource.Text = "127.0.0.1";
            // 
            // label1
            // 
        ...
        public SyBase_Connection Connection
        {
            get
            {
                SyBase_Connection connection1 = new SyBase_Connection {
                    database = DESEncrypt.Encrypt(this.tbDataBase.Text),
                    UID = DESEncrypt.Encrypt(this.tbUser.Text),
                    PWD = DESEncrypt.Encrypt(this.tbPassword.Text),
                    DataSource = DESEncrypt.Encrypt(this.tbDataSource.Text),
                    Port = Convert.ToInt32(this.tbservername.Text)
                };
                ...
                {
                    object[] objArray1 = new object[] { "Data Source=", DESEncrypt.Decrypt(this._connection.DataSource), ";Port=", this._connection.Port, ";servername=", DESEncrypt.Decrypt(this._connection.servername), "database=", DESEncrypt.Decrypt(this._connection.database), ";UID=", DESEncrypt.Decrypt(this._connection.UID), ";PWD=", DESEncrypt.Decrypt(this._connection.PWD) };
                    this._connection.ConnectionString = DESEncrypt.Encrypt(string.Concat(objArray1) ?? "");
                }
            ...
            set
            {
                ...
                if (this._connection != null)
                {
                    ...
                    this.tbUser.Text = DESEncrypt.Decrypt(this._connection.UID);
                    this.tbPassword.Text = DESEncrypt.Decrypt(this._connection.PWD);
                    this.tbservername.Text = DESEncrypt.Decrypt(this._connection.servername.ToString());
