namespace Modbus.ModbusService
{
    ...
    public class ZYBServer
    {
        ...
        private readonly Dictionary<long, ClientConnection> mClientConnections;
        ...
        public event ClientErrorEvent OnError;

        public event OnDataInHandler OnDataIn;

        public event OnDisconnectedHandler OnDisconnected;
        public bool ServerIsSuspend = true;
        ...
        {
            this.mClientConnections = new Dictionary<long, ClientConnection>();
        ...
        private void HandleConnection(IAsyncResult parameter)
        {
            ...
            try
            {
                ...
                {
                    this.OnConnected(this, new ZYBConnectedEventArgs(connection));
                }
        ...
        {
            if ((this.OnError != null) && (connection != null))
            {
                this.OnError(connection.EndPoint, error);
            }
        }
