namespace Modbus.Device
{
    ...
    public abstract class ModbusSlave : ModbusDevice
    {
        ...
        ///     在处理请求功能之前，当Modbus从机收到请求时引发。
        /// </summary>
        /// <exception cref="InvalidModbusRequestException">The Modbus request was invalid, and an error response the specified exception should be sent.Modbus请求无效，应发送指定异常的错误响应</exception>
        ...
        ///     在处理函数的写入部分后，当Modbus从机收到写入请求时引发。
        /// </summary>
        ...
        /// 对于读/写多个寄存器（函数代码23），此方法在写入之后和读取之前引发
