namespace Modbus.Device
{
    ...
    /// <summary>
    ///     Modbus serial master device.Modbus串行主设备
    /// </summary>
    public class ModbusSerialMaster : ModbusMaster, IModbusSerialMaster
    {
        ...
        /// <summary>
        ///     Serial Line only. 仅串行线。
        ///     Diagnostic function which loops back the original data.循环回原始数据的诊断函数。
        ///     NModbus only supports looping back one ushort value, this is a limitation of the "Best Effort" implementation ofNModbus只支持循环回一个ushort值，这是
        ///     the RTU protocol.
        /// </summary>
