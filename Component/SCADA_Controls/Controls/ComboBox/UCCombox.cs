            ...
            if (_frmAnchor == null || _frmAnchor.IsDisposed || _frmAnchor.Visible == false)
            {
                ...
                if (this.Source != null && this.Source.Count > 0)
                {
                    ...
                    while (true)
                    {
                        ...
                        if ((p.Y + this.Height + this.Source.Count / intCom * 30 < intScreenHeight || p.Y - this.Source.Count / intCom * 30 > 0)
                            && (_dropPanelHeight <= 0 ? true : (this.Source.Count / intCom * 30 <= _dropPanelHeight)))
                        {
                    ...
                    if (intWidth < _ItemWidth)
                        intWidth = _ItemWidth;
                    Size size = new Size(intCom * intWidth, intRow * 30);
                    ucTime.Size = size;
