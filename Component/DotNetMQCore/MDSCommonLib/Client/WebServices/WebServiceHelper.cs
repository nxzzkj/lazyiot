...
namespace MDS.Client.WebServices
{
    ...
    public static class WebServiceHelper
    {
        ...
        /// <summary>
        /// Deserializes an incoming message for Web Service from MDS server.从MDS服务器反序列化Web服务的传入消息。
        /// </summary>
        ...
        /// <summary>
        /// Serializes a message to send to MDS server from Web Service.序列化要从Web服务发送到MDS服务器的消息。
        /// </summary>
